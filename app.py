...
# Retrieve the key from the OS environment (accept either common name)
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY") or os.environ.get("GOOGLE_API_KEY")

if not GEMINI_API_KEY:
    raise RuntimeError(
        "No API key found. Set the GEMINI_API_KEY (or GOOGLE_API_KEY) "
        "environment variable in your Render service's Environment tab, "
        "then redeploy."
    )
